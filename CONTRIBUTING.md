# Contributing to ZK Gaming Toolkit

We would love for you to contribute to the Toolkit and help make it even better than it is
...
Help us keep the Toolkit open and inclusive. Please read and follow our [Code of Conduct](code_of_conduct.md).
...
Before you submit an issue, please search the [issues tracker](https://github.com/Kryha/zk-gaming-toolkit/issues), maybe an issue for your problem already exists and the discussion might inform you of workarounds readily available.
...
- Version of the Toolkit used
- Browser and version used
- Step by step guide on how reach the issue

You can file new [issues in github](https://github.com/Kryha/zk-gaming-toolkit/issues)
...
1. Search [GitHub](https://github.com/Kryha/zk-gaming-toolkit/pulls) for an open or closed PR
   that relates to your submission. You don't want to duplicate effort.
2. Fork the [Kryha/zk-gaming-toolkit](https://github.com/Kryha/zk-gaming-toolkit) repo.
...
6. Run the full the Toolkit test suite, as described in the [Readme][readme],
...
9. In GitHub, send a pull request to `zk-gaming-toolkit:develop`.

- If we suggest changes then:

  - Make the required updates.
  - Re-run the the Toolkit test suites to ensure tests are still passing.
...
we use the git commit messages to **generate the the Toolkit change log**.
...
Check the [last commits](https://github.com/Kryha/zk-gaming-toolkit/commits)
...
[readme]: https://github.com/Kryha/zk-gaming-toolkit/blob/develop/README.md
[github]: https://github.com/Kryha/zk-gaming-toolkit
